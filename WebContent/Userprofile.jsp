...
<title>Answering Natural Language Question by subgraph matching : :User Profile</title>
		...
		<section id="main-content">
           ...
           <%
               ...
               String email=(String)session.getAttribute("uname");
            		  ResultSet rs=dao.viewProfile(email);
            		  if(rs.next()){
           %>
					
						<label for="usr">Name:</label> <input type="text" class="ggg"
							id="usr" value="<%= rs.getString(2)%>">
					
					
						<label for="pwd">Email:</label> <input type="text" name="email" class="ggg"
							 id="pwd"value="<%=rs.getString(4) %>">
					
					
						<label for="pwd">Mobile:</label> <input type="text" name="mobile"class="ggg"
							 id="pwd"value="<%=rs.getString(5) %>">
					
				<%	} %>
				<input type="submit" value="Update profile" name="login">
