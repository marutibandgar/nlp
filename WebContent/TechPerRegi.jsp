...
<html>
<head>
<title>Answering Natural Language Question by subgraph matching| Registration :: w3layouts</title>
...
<div class="w3layouts-main">
	<h2>Register Now</h2>
		<form action="TechPersonServlet" method="post">
			...
			<input type="text" class="ggg" name="mobile" pattern=".{10}" placeholder="PHONE" required="required">
			...
			<select  class="ggg" name="language"  required="required">
		...
		<p>Already Registered.<a href="TechPerLogin.jsp">Login</a></p>
</div>
</div>
