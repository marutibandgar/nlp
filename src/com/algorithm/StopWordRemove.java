...
public static String[] stopWordsofwordnet = {
	"details","a","information", "as", "able", "about","Why","What","is",
...
public static String stopword(String s)
{
   ...
   System.out.println(s);
	s=s.trim().replaceAll("\\s+", " ");//  what is jdbc  ?==what is jdbc?
	String[] words = s.split(" ");//words get split by using space 
...
String s="Why multiple inheritance is not supported in java?";
StopWordRemove cl=new StopWordRemove();
cl.stopword(s);
